document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function showErrors(errors) {
            errorContainer.innerHTML = errors.map(function(msg) {
                return '<p style="margin:0.25rem 0">' + msg + '</p>';
            }).join('');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'da5d4db3-94fa-48d0-bdf8-e7f8791dca50',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'da5d4db3-94fa-48d0-bdf8-e7f8791dca50';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'da5d4db3-94fa-48d0-bdf8-e7f8791dca50';
